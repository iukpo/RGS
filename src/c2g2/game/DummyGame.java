...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        String meshName="src/resources/models/bunny.obj";
        Mesh mesh = OBJLoader.loadMesh(meshName);
         ...
         * 
         * So here, we initialize the texture object and set it within the mesh before passing the mesh into the
         * GameItem.
         * 
         * While this makes it easier to see all the shader effects for meshes that have texture, it has lead to the
         * side effect of meshes without texture not displaying when a texture shader is applied to them. This does
         * not, however, affect the performance of the non-texture shaders on either object type.
         * 
         * (I. Ukpo)
         */
        ...
        //Normal map texture. Created separately in Photoshop (Filter->3D->Create Normal Map).
        Texture normalMapTexture = new Texture("/resources/textures/grassblocknormalmap.png");
        
        //Set the textures.
        mesh.setTexture(texture,normalMapTexture);
        GameItem gameItem = new GameItem(mesh);
        
        /*NOTE: Much like in my other project SLOML, these values will have to be adjusted per model.
         * These values are for the Stanford bunny.
         * TODO: extend code to accept these values at command line.
         */
        gameItem.setScale(0.25f);
        gameItem.setPosition(-0.60f, -0.85f, -2.0f);
    ...
    public void input(Window window, MouseInput mouseInput) {
        ...
        /*
         * To make it easier to move between all the shaders without having to press the space bar, 
         * I extended the recognizable keys.
         * 
         * Here's what each of the keys correspond to:
         * 3=phong
         * 4=skeleton
         * 5=Gouraud
         * 6=texture modulation
         * 7=checkerboard
         * 8=normal map
         * 9=cel
         * 2=dots (extra shader)
         ...
         */
            ...
            // select current shader
            currentShaderIndex = 6 % renderer.getNumShaders();
            System.out.println("selected shader: " +  renderer.getShaderName(currentShaderIndex));
        }
        else if(window.isKeyPressed(GLFW_KEY_2)){
            // select current shader
            currentShaderIndex = 7 % renderer.getNumShaders();
            System.out.println("selected shader: " +  renderer.getShaderName(currentShaderIndex));
        }
        else if(window.isKeyPressed(GLFW_KEY_1)){
            // select current shader
            currentShaderIndex = 8 % renderer.getNumShaders();
            System.out.println("selected shader: " +  renderer.getShaderName(currentShaderIndex));
        }
