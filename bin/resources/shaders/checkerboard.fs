//Adapted from https://github.com/ernestosc/comp-graphics/blob/master/shaders/src/ch.frag
...
void main()
{
	 ...
	 */
	float scaled_s = floor(10.0 * outTexCoord.x);
	float scaled_t = floor(10.0 * outTexCoord.y);
	 ...
	 */
	float fcolor = mod(scaled_s + scaled_t, 2.0);
